...
If you are a **teacher**, Vagrant will automatically create a consistent learning
environment on a wide variety of hardware and operating systems. This allows you
to prepare a course for this specific environment without having to worry about
varying software versions and incompatibilites. Vagrant boxes are also easily
importable from external drives, making network access another non-issue.
