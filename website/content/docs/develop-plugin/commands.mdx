...
This page documents how to add new commands to Vagrant, invocable via `vagrant YOUR-COMMAND`. Prior to reading this, you should be familiar with the [plugin development basics](/vagrant/docs/plugins/development-basics).

<Note heading="Advanced Topic">

Developing plugins is an advanced topic that only experienced Vagrant users who are reasonably comfortable with Ruby should approach.
