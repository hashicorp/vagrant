...
## Write a guest plugin

A guest must satisfy the interface defined for a guest component. Refer to the [component.go](https://github.com/hashicorp/vagrant-plugin-sdk/blob/main/component/component.go) file for the source code.
...
<CodeBlockConfig filename="myplugin/guest/myguest.go">
...
<CodeBlockConfig filename="myplugin/main.go">
