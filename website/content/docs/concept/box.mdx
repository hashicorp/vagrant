...
Boxes require a provider, a virtualization product, to operate. Before you can use a box,  ensure that you have properly installed a supported [provider](/vagrant/docs/providers).
...
The boxes on the public catalog work with many different [providers](/vagrant/docs/providers/). The list of supported providers is located in the box descriptions.  
