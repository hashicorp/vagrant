...
$vagrant_os_order  = %w(darwin windows debian rpm)
$vagrant_downloads = {}
$vagrant_versions  = []

if ENV['VAGRANT_VERSION']
  puts 'Finding downloads for Vagrant'
  fail 'BINTRAY_API_KEY must be set.' unless ENV['BINTRAY_API_KEY']
