...
installation easy, Vagrant is distributed as a [binary package](/downloads)
...
To install Vagrant, first find the [appropriate package](/downloads) for
...
[setting up your first Vagrant project](/intro/getting-started/project_setup).
