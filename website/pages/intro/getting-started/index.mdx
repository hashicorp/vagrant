...
should also read the ["Why Vagrant?"](/intro) page.
...
can work with [many other providers](/intro/getting-started/providers).
...
book, you may be interested in [Vagrant: Up and Running](https://www.amazon.com/gp/product/1449335837/ref=as_li_qf_sp_asin_il_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1449335837&linkCode=as2&tag=vagrant-20),
...
learn more about [project setup](/intro/getting-started/project_setup).
