...
The path provided from this command can be used to set the [`utility_certificate_path`](/docs/vmware/configuration.html#utility_certificate_path) in the Vagrantfile
