...
- `key_protector` (string) - A UTF-8 encoded string representing a key protector for the VM. Default: will generate one for the VM if `enable_trusted_platform_module` is true
