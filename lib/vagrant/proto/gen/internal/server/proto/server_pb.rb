...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("internal/server/proto/server.proto", :syntax => :proto3) do
    ...
    add_message "hashicorp.vagrant.Machine" do
      optional :machine, :message, 1, "google.protobuf.Any"
      ...
      optional :state, :enum, 10, "hashicorp.vagrant.Operation.PhysicalState"
      optional :remote_enabled, :bool, 11
      optional :data_source, :message, 12, "hashicorp.vagrant.Job.DataSource"
    end
