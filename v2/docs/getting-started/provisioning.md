...
you can also [extend vagrant](/v2/docs/provisioners/others.html) to support more provisioners, but this is an advanced topic
...
details on this can be found in the [chef solo documentation](/v2/docs/provisioners/chef_solo.html).
...
Alternatively you can run Puppet in client-server mode by enabling the `:puppet_server` provisioner.  See the [Puppet Server](/v2/docs/provisioners/puppet_server.html) documentation for more details.
