shared_examples 'a version 4.x virtualbox driver' do |_options|
  before do
    fail ArgumentError, 'Need virtualbox context to use these shared examples.' unless defined? vbox_context
  end
