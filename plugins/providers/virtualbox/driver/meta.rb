      ...
      class Meta < Base
        ...
        def initialize(uuid = nil)
          ...
          if @version.start_with?('4.2.14')
            ...
            fail Vagrant::Errors::VirtualBoxBrokenVersion040214
          end
          ...
          unless driver_klass
            ...
            fail Vagrant::Errors::VirtualBoxInvalidVersion,
          ...
          if @uuid
            ...
            fail VMNotFound unless @driver.vm_exists?(@uuid)
          end
        end
        ...
        def read_version
          ...
          if output =~ /vboxdrv kernel module is not loaded/ ||
            ...
            fail Vagrant::Errors::VirtualBoxInstallIncomplete
          end
