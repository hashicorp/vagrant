    ...
    class SyncedFolder < Vagrant.plugin('2', :synced_folder)
      ...
      def usable?(_machine, raise_error = false)
        unless Vagrant::Util::Platform.windows?
          fail Errors::WindowsHostRequired if raise_error
          return false
        end

        unless Vagrant::Util::Platform.windows_admin?
          fail Errors::WindowsAdminRequired if raise_error
          return false
        end
      ...
      def enable(machine, folders, _nfsopts)
        ...
        unless machine.guest.capability?(:mount_smb_shared_folder)
          fail Vagrant::Errors::GuestCapabilityNotFound,
